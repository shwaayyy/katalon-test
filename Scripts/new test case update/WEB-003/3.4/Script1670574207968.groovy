...
WebUI.click(findTestObject('Object Repository/Page_Digisign Proses Dokumen/label_Iya'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Digisign Proses Dokumen/label_Iya'), 30)
