...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Digisign Kirim/selectaction'), GlobalVariable.PENGECEKAN, 
    false)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Digisign Kirim/button_Info'), 30)
