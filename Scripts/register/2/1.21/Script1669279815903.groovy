...
WebUI.setText(findTestObject('Page_Digisign Pendaftaran/input_Tempat Lahir_lbrith'), 'sda')

WebUI.click(findTestObject('Page_Digisign Pendaftaran/button_Next'))

WebUI.setText(findTestObject('Page_Digisign Pendaftaran/input_Username_username'), 'watyre')

WebUI.click(findTestObject('Object Repository/Page_Digisign Pendaftaran/div_Password_pass-graybar'))
...
WebUI.setText(findTestObject('Page_Digisign Pendaftaran/input_Email_email'), 'akun.net17@gmail.com')

WebUI.click(findTestObject('Page_Digisign Pendaftaran/buttonNextInfo'))

WebUI.verifyElementPresent(findTestObject('Page_Digisign Pendaftaran/validationNumber'), 0)
