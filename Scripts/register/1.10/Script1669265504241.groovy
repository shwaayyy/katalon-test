...
WebUI.setText(findTestObject('Object Repository/Page_Digisign Pendaftaran/input_Nama_name'), 'ads')

WebUI.setText(findTestObject('Object Repository/Page_Digisign Pendaftaran/input_Tempat Lahir_lbrith'), 'asd')
...
WebUI.click(findTestObject('Object Repository/Page_Digisign Pendaftaran/button_Back'))

WebUI.setText(findTestObject('Object Repository/Page_Digisign Pendaftaran/input_Username_username'), 'sd')

WebUI.verifyElementPresent(findTestObject('Page_Digisign Pendaftaran/div_Panjang karakter minimal 6, maksimal 15_4f80bf'), 
    0)
