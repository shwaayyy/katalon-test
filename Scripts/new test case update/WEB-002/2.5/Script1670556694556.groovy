...
WebUI.setText(findTestObject('Object Repository/Page_Digisign Kirim/input_Nama_name-1'), 'a5435+_=-45?":@#$')

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/div_Simbol tidak dapat didukung sebagai isian'))
