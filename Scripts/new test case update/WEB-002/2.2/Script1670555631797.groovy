...
WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/label_Tidak, Bayar masing - masing'))

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/label_Ya'))

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/label_Ya_1'))

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/label_Tidak'))

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/i_event'))

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/div_8'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Digisign Kirim/div_Hlm.  1 Dari   1                  Tanda_554829'), 
    30)
