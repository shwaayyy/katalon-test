...
WebUI.setText(findTestObject('Page_Digisign Pendaftaran/input_Tempat Lahir_lbrith'), 'asda')

WebUI.click(findTestObject('Page_Digisign Pendaftaran/button_Next'))

WebUI.setEncryptedText(findTestObject('Page_Digisign Pendaftaran/input_Password_password'), 'MWVzhgMx1wKOwWYznXseCQ==')

WebUI.verifyElementPresent(findTestObject('Page_Digisign Pendaftaran/span_Strong password'), 0)
