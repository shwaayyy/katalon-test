...
WebUI.dragAndDropByOffset(findTestObject('Page_Digisign Kirim/div_Sign Here'), 5, 200)

WebUI.dragAndDropByOffset(findTestObject('Page_Digisign Kirim/div_Sign Here_ui-resizable-handle ui-resiza_f3e899'), 20, 
    27)
...
WebUI.verifyElementPresent(findTestObject('Page_Digisign Kirim/div_Dokumen berhasil dikirim'), 30)
