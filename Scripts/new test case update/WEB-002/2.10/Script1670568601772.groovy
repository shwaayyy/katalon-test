...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Digisign Kirim/div_Batas waktu tidak valid'), 30)

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/button_OK_alert'))
