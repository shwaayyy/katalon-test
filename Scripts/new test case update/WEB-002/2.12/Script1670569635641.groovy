...
WebUI.dragAndDropByOffset(findTestObject('Page_Digisign Kirim/div_Sign Here'), 4, 128)

WebUI.dragAndDropByOffset(findTestObject('Page_Digisign Kirim/div_Sign Here_ui-resizable-handle ui-resiza_f3e899'), -32, 
    -107)
