...
WebUI.uploadFile(findTestObject('Object Repository/Page_Digisign/inputfile'), 'C:\\\\wayyy\\\\backup\\\\photo_2022-12-07_17-46-49.jpg')

WebUI.click(findTestObject('Object Repository/Page_Digisign/button_Unggah Dokumen'))

WebUI.verifyElementPresent(findTestObject('Page_Digisign Draf/h5_File pdf rusak'), 30)
