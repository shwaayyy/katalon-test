...
WebUI.click(findTestObject('Object Repository/Page_Digisign Proses Dokumen/a_Batal'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('Page_Digisign Kotak Masuk/h5_Kotak Masuk'), 30)
