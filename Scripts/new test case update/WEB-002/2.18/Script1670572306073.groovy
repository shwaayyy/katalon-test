...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Digisign Kirim/selectaction'), GlobalVariable.PARAF, false)

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/button_Lanjutkan'))

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/button_Paraf'))

WebUI.dragAndDropByOffset(findTestObject('Object Repository/Page_Digisign Kirim/div_Paraf'), 650, 0)

WebUI.click(findTestObject('Object Repository/Page_Digisign Kirim/button_Paraf_lockinit1'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Digisign Kirim/div_Dokumen gagal dikirim'), 30)
