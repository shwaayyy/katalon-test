...
WebUI.click(findTestObject('Object Repository/Page_Digisign Proses Dokumen/button_Tidak, Batal'))

WebUI.verifyElementPresent(findTestObject('Page_Digisign Proses Dokumen/div_DibatalkanProses dibatalkan    OK'), 30)

WebUI.click(findTestObject('Page_Digisign Proses Dokumen/button_OK_dibatalkan'))
