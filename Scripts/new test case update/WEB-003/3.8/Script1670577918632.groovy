...
WebUI.click(findTestObject('Object Repository/Page_Digisign Proses Dokumen/button_Email'))

WebUI.setText(findTestObject('Object Repository/Page_Digisign Proses Dokumen/input_Masukkan OTP_otp'), '234570')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Digisign Proses Dokumen/div_Kode verifikasi salah'), 30)

WebUI.click(findTestObject('Object Repository/Page_Digisign Proses Dokumen/button_OK_verifikasi_salah'))
